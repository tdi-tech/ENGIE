...
const changelogData: { id: string; version: string; date: string; tag: string; title: string; changes: { id: string; type: string; text: string }[] }[] = [
    {
        ...
        changes: [
            ...
            { id: 'c11', type: 'feature', text: 'Nueva analítica "Top Actores / Fuentes Recurrentes" en el Dashboard → Menciones: radar (Chart.js) con los seis actores o fuentes de más menciones registradas, acompañado del ranking que muestra el número concreto de menciones y su porcentaje sobre el total. Reutiliza la misma clave analítica de los reportes (Usuario o Sitio Web → @usuario o dominio), se colorea con los tokens corporativos según el tema claro/oscuro y se incorporó también como bloque del PDF ejecutivo del panel.' },
